...
class Responsable_area extends CI_Controller {
	...
	public function listarAjax(){
		if(!$this->input->is_ajax_request()):
			...
			//if(esLogeado()):
				...
				$result_sql = $this->personal_model->listarPersonal( 'RESPONSABLE_AREA' );
			...
			//if(esLogeado()):
				...
				if( isset($result_sql[0]['result']) ):
					if($result_sql[0]['result'] == 1):
						$result["estado"] 	= 1;		
						$result["mensaje"] 	= 'Responsable de Area Registrado';
						$result["result"] 	= $result_sql[0];
					else:
						if($result_sql[0]['result'] == -1 && $result_sql[0]['pid1'] == null):
							$result["estado"] 	= 3;		
							$result["mensaje"] 	= 'Error al registrar Responsable de Area';
							$result["result"] 	= $result_sql[0];
						else:
							$result["estado"] 	= 3;		
							$result["mensaje"] 	= 'Responsable de Area Registrado anteriormente';
							$result["result"] 	= $result_sql[0];
						endif;
					endif;
				else:
