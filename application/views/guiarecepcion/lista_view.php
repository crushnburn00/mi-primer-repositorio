...
<div class="row3" id="div-foot" >
		<div class="col-6 col-md-6 col-lg-1 offset-lg-1">
			<div class="social">
		 		<a href="<?=base_url();?>acopio" class="social__button icon_pie"><i class="icon-undo2"></i></a>
			</div>
		</div>
