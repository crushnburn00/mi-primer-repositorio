...
<div class="container-fluid" id="div-listado" >
	...
	<div class="row">
			<div class="container-fluid form-group" id="div_listado_certificacion">
				...
				<div class="table table-bordered" id="">	
					...
					<div class="form-group col-12 row3 thead_div" >
						...
						<div class="col-md-3">
							<label class="form-control-sm col-md-8" id="">Tipo Certificacion</label>
							<label class="form-control-sm col-md-2 icon- col-md-1" id="codigo_ord"></label>
						</div>
						<div class="col-md-3">
							<label class="form-control-sm col-md-8" id="">Entidad Certificadora</label>
							<label class="form-control-sm col-md-2 icon- col-md-1" id="departamento_ord"></label>
						</div>
						<div class="col-md-2">
							<label class="form-control-sm col-md-8" id="">Fecha Emision</label>
							<label class="form-control-sm col-md-2 icon- col-md-1" id="provincia_ord"></label>
						</div>
						<div class="col-md-2 ">
							<label class="form-control-sm col-md-8" id="">Fecha Expiracion</label>
	...
	<div class="row" id="foot_tb_certificacion">
		<div class="col-md-3 row" id="encabezado_tb_certificacion">
...
<div class="row3" id="div-foot" >
		<div class="col-6 col-md-6 col-lg-1 offset-lg-1">
			<div class="social">
		 		<a href="<?=base_url();?>finca/listar/<?=$finca['id_socio'];?>" class="social__button icon_pie"><i class="icon-undo2"></i></a>
			</div>
		</div>
