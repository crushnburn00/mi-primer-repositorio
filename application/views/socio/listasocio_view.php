			...
			<div class="container-fluid form-group" id="div_listado_socio">
				...
				<div class="table table-bordered" id="">	
					...
					<div class="form-group col-12 row2 thead_div" >
						...
						<div class="col-1 ">Codigo Productor</div>
				      	<div class="col-2 ">Tipo Doc.</div>
						<div class="col-2 ">Nro Documento</div>
						<div class="col-3 ">Apellidos y Nombres / Razon Social</div>
						<div class="col-2 ">Fec.Registro</div>
