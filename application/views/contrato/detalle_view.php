			        ...
			        <div class = "div-marco" id="div-productor_0">	
				        ...
				        <div class = "" id="div-productor">	        	
						    ...
						    <div class="row">					
								<div class="col-md-12 row2">
									...
									<label class="col-md-12 bold" id="lblRegistroProductor">
										Estado : <?=$aContrato['desc_estado_contrato'];?>
									</label>
								</div>
							</div>
						...
						<div class = "" id="div-">	
			       		...
			       		<div class="col-12 row2">
								...
								<?php
								if($aAsignado[0]['p_result']==-2):?>	
									<div  class="col-md-12 bold encabezado1 " style="color:red; text-align: right;">PARA ASIGNAR CONTRATO PRIMERO DEBE CAMBIAR EL ESTADO DE FIJACIÓN "FIJADO"</div>
								<?php
								endif;
								?>
						...
						echo form_open(base_url().'', array(
										        ...
										        'role' => 'form' ));
						echo form_hidden('txtIdContrato', $aContrato['id_contrato']);?>
						<div class="row3">
						...
						?>
							...
							<label for=""  class="form-control-sm show col-md-4" id=""><?=$aContrato['peso_neto_kg'];?></label>
							<div class="col-md-2 col-form-label bold">KG Pergamino</div>
							<label for=""  class="form-control-sm show col-md-4" id=""><?=$aContrato['kg_pergamino'];?></label>
							<div class="col-md-2 col-form-label bold">% Rendimiendo</div>
							<label for=""  class="form-control-sm show col-md-4" id=""><?=$aContrato['ini_rendimiento'];?></label>
							<div class="col-md-2 col-form-label bold">Peso neto en QQ</div>
							<label for=""  class="form-control-sm show col-md-4" id=""><?=$aContrato['kg_qq'];?></label>
							<div class="col-md-2 col-form-label bold">Total KG Pergamino</div>
							<label for=""  class="form-control-sm show col-md-4" id=""><?=$aContrato['total_kg_pergamino'];?></label>
						<?php endif;?>
						...
						<div class="col-12 row2">
								...
								<?php
								if($aAsignado[0]['p_result']==-2):?>	
								<button class="btn btn-sm btn-primary  col-md-2" name='btnEditarContratoestado' value='Editar' id='btnEditarContratoestado'>
								...
								if($aAsignado[0]['p_result']==-2):?>
									<div class="col-6">
									<?= form_open(base_url().'', array(
										        'name' => 'form_contratoestadodetalle',
										        'id'=>'form_contratoestadodetalle',
										        'class'=> 'form-contratoestadodetalle',
										        'role' => 'form' ));
									?>
										<div class="row" id="div-contratoestado">
										
										<?=form_hidden('txtId', $aContrato['id_contrato']);?>
										

										<div   class="col-md-4 col-form-label bold required1">Estado Fijacion</div>
										<label for="descestado"  class="form-control-sm show col-md-8" id="lblestado"><?=$aContrato['estado_fijacion'];?></label>
										<label for="estado"  class="d-none" id="lblestado1"><?=$aContrato['id_estado_fijacion'];?></label>

										<?php

											$optionsTar = array(6 => 'FIJADO' , 7 => 'SIN FIJAR');            
											$adicional = 'class="form-control form-control-sm" id="estado" ';
											
											echo '<div class="col-md-8 row no-gutters hidden no-show">
											<div class="col-12">'.form_dropdown('cboEstadoFijacion', $optionsTar, $aContrato['id_estado_fijacion'] ,$adicional).'</div>
											</div>';

											// boton Reenvio
									    	$formatoReenvio = array(
									        	'name' => 'btnGuardarContratoestado',
									        	'value' => 'Guardar Cambios',
									        	'id' => 'btnGuardarContratoestado',
									        	'class' => 'btn btn-sm btn-primary btn-block',
									        	'disabled' => 'disabled'
									    	);

									    	echo '<div class="col-md-6 offset-lg-4 col-lg-2" style="display:none" id="div-btnGuardarContratoestado">'.form_submit($formatoReenvio).'</div>';
									    	echo '<div class="col-md-6 col-lg-2"  id="div-btnCancelarContratoestado"><button name="btn" value="CANCELAR" id="btnCancelarContratoestado" class="btn btn-sm btn-secondary btn-block" disabled="disabled" style="display:none">Cancelar</button></div>';
										?>
