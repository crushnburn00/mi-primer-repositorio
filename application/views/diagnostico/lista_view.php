	...
	<div class="col-12 div-botones" >
		...
		<?php
			foreach ($btn as $key => $row) {
				if ($row['id_modulo'] == 46) {
					echo '<a id="'.$row['id_modulo'].'" title="'.$row['descripcion'].'" href="'.base_url().'assets/pdf/PlantillaDiagnostico.pdf" class="col-5 col-lg-2 btn btn-sm btn-effect-tracer">
			...
			<div class="container-fluid form-group" id="div_listado_certificacion">
				...
				<div class="table table-bordered" id="">	
					...
					<div class="form-group col-12 row3 thead_div" >
						<div class="col-md-4">
							<label class="form-control-sm col-md-8" id="">Codigo</label>
